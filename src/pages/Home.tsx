	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden'>
			...
			<div className='absolute inset-0 opacity-20'>
				...
				<div className='absolute bottom-10 left-20 w-72 h-72 bg-red-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000'></div>
			</div>
			...
			<div className='container mx-auto px-4 py-8 relative z-10'>
				<div className='text-center mb-12'>
					...
					<h1 className='text-5xl md:text-7xl font-black mb-6 leading-tight'>
						...
						<br />
						<span className='text-white text-4xl md:text-6xl'>From Just</span>
					...
					<div className='bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-8 py-4 rounded-2xl inline-block mb-8 shadow-2xl shadow-yellow-500/30 transform hover:scale-105 transition-all duration-300'>
					...
					<div className='relative max-w-5xl mx-auto mb-8'>
						<div
							className='relative aspect-video bg-gradient-to-br from-gray-900 to-black rounded-2xl overflow-hidden cursor-pointer group shadow-2xl border-4 border-red-500 hover:border-yellow-400 transition-all duration-500'
							...
							<div className='absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/80 flex items-center justify-center group-hover:from-black/60 group-hover:to-black/60 transition-all'>
								<div className='text-center'>
									<div className='bg-gradient-to-r from-red-600 to-red-700 rounded-full p-8 mb-6 mx-auto w-28 h-28 flex items-center justify-center group-hover:scale-125 transition-transform duration-500 shadow-2xl shadow-red-500/50 animate-pulse'>
										<Play size={40} className='ml-2 text-white' />
									</div>
									<h3 className='text-2xl md:text-3xl font-black mb-4 text-yellow-400 drop-shadow-lg'>
							...
							<div className='absolute bottom-4 left-4 bg-red-600 bg-opacity-90 px-4 py-2 rounded-full text-sm font-bold border-2 border-yellow-400'>
				...
				<div className='max-w-4xl mx-auto mb-16'>
					<div className='bg-gradient-to-r from-green-900/50 to-emerald-900/50 backdrop-blur-sm rounded-2xl p-8 border-2 border-green-400 shadow-2xl shadow-green-500/20'>
						...
						<div className='grid md:grid-cols-3 gap-6 mb-8'>
							<div className='text-center bg-black/30 rounded-xl p-6 border border-yellow-400'>
							...
							<div className='text-center bg-black/30 rounded-xl p-6 border border-green-400'>
							...
							<div className='text-center bg-black/30 rounded-xl p-6 border border-red-400'>
						...
						<div className='bg-black/50 rounded-xl p-6 border border-yellow-400'>
				...
				<div className='max-w-4xl mx-auto mb-16'>
					<div className='text-center mb-12'>
						...
						<div className='bg-gradient-to-r from-purple-900/50 to-indigo-900/50 backdrop-blur-sm rounded-2xl p-8 border-2 border-purple-400 shadow-2xl'>
				...
				<div className='max-w-4xl mx-auto mb-16'>
					<div className='bg-gradient-to-r from-red-900/50 to-orange-900/50 backdrop-blur-sm rounded-2xl p-8 border-2 border-red-400 shadow-2xl shadow-red-500/20'>
				...
				<div className='max-w-4xl mx-auto mb-16'>
					<div className='text-center mb-12'>
						...
						<div className='bg-gradient-to-br from-purple-900/50 to-indigo-900/50 backdrop-blur-sm rounded-2xl p-8 border-2 border-purple-400 shadow-2xl'>
					...
					<div className='bg-gradient-to-r from-green-600/30 to-emerald-600/30 border-4 border-green-400 rounded-2xl p-8 mb-12 shadow-2xl shadow-green-500/30'>
						<div className='text-center'>
