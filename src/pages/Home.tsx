...
const Home: React.FC = () => {
	...
	const handlePaystackCheckout = (): void => {
		...
		if (
			...
			console.error(
				'PaystackPop or its setup method is not defined. Ensure Paystack script is loaded in index.html and accessible.'
			);
			setIsLoading(false);
						...
						<div className='space-y-4'>
							<div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
								...
								<p className='text-sm text-gray-600 mt-2'>
									(After transfer, click to send receipt and email for
									confirmation)
								</p>
							</div>
							<div>
								<h1 className=' text-center text-red-500 font-bold'>OR</h1>
							</div>
